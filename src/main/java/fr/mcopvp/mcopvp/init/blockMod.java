...
public class blockMod {
    ...
    public static void init(){
        jade_ore = new blockBasique(Material.rock).setBlockName("jade_ore").setCreativeTab(CreativeTabs.tabBlock).setBlockName(References.MODID + ":jade_ore").setHardness(3);
    }
